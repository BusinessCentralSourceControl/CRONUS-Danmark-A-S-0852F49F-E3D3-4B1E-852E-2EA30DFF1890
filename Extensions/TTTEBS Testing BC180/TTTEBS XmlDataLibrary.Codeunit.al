codeunit 90002 "TTTEBS XmlDataLibrary"
{
    Access = Internal;

    procedure GetXmlSchema()SchemaText: Text var StringBuilder: TextBuilder;
    begin
    ...
    procedure GetNamespace(): Text begin
        exit('http://www.contoso.com/books');
    end;
    procedure GetValidXml()Xml: Text var StringBuilder: TextBuilder;
    begin
        StringBuilder.Append('<?xml version="1.0" encoding="utf-8" ?>');
...
/// </summary>
 procedure GetInvalidXml()Xml: Text var XmlDoc: XmlDocument;
